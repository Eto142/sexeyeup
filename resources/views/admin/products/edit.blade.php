    ...
    <div class="col-lg-4">
        ...
        <div class="table-card p-4 mt-4">
            ...
            <select name="location" class="form-select @error('location') is-invalid @enderror" required>
                <option value="both"    {{ old('location', $product->location) == 'both'    ? 'selected' : '' }}>Both Locations</option>
                <option value="bayelsa" {{ old('location', $product->location) == 'bayelsa' ? 'selected' : '' }}>Bayelsa Only</option>
                <option value="benin"   {{ old('location', $product->location) == 'benin'   ? 'selected' : '' }}>Benin Only</option>
            </select>
