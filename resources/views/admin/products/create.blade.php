            ...
            <div class="row g-3">
                <div class="col-sm-6">
                    ...
                    <input type="text" name="name" class="form-control @error('name') is-invalid @enderror"
                           value="{{ old('name') }}" placeholder="e.g. OG Kush" required>
                ...
                <div class="col-sm-6">
                    ...
                    <select name="category" class="form-select @error('category') is-invalid @enderror" required>
                        ...
                        <option value="flower"      {{ old('category')=='flower'      ? 'selected' : '' }}>🌸 Flower</option>
                        <option value="edible"      {{ old('category')=='edible'      ? 'selected' : '' }}>🍪 Edibles</option>
                ...
                <div class="col-sm-6">
                    ...
                    <div class="input-group">
                        ...
                        <input type="number" name="price_gram" step="1" min="0"
                               ...
                               value="{{ old('price_gram') }}" placeholder="e.g. 5000" required>
                    </div>
                ...
                <div class="col-sm-6">
                    ...
                    <div class="input-group">
                        ...
                        <input type="number" name="price_ounce" step="1" min="0"
                               ...
                               value="{{ old('price_ounce') }}" placeholder="e.g. 120000" required>
                    </div>
                ...
                <div class="col-sm-3">
                    ...
                    <input type="number" name="rating" step="0.1" min="0" max="5"
                           class="form-control" value="{{ old('rating', '0') }}" placeholder="4.5">
                </div>
                <div class="col-sm-3">
                    <label class="form-label">Review Count</label>
                    <input type="number" name="reviews" min="0"
                           class="form-control" value="{{ old('reviews', '0') }}" placeholder="0">
                </div>
                <div class="col-12">
                    <label class="form-label">Description</label>
                    <textarea name="description" class="form-control" rows="4"
                              placeholder="Short product description…">{{ old('description') }}</textarea>
                </div>
            </div>
        </div>
    </div>
